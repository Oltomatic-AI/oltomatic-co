      ...
      <section className="relative pt-40 pb-24 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-6">
          <span className="tag mb-6 inline-flex">
            ...
            {es ? "OLTO Suite · Herramientas Operativas" : "OLTO Suite · Operational Tooling"}
          </span>
          ...
          <p className="mb-10 max-w-xl" style={{ fontSize: "18px", color: "#9999B0", lineHeight: "1.7" }}>
            {es
              ? "OLTO Suite es el centro operativo de tu negocio — un conjunto de herramientas, cada una construida para resolver un problema real en cómo los negocios realmente funcionan. Actívalas según las necesites: recepción de trabajos, aprobaciones, notificaciones, programación. Configurado alrededor de tu operación, no al revés."
              : "OLTO Suite is your operational hub — a set of tools you turn on as you need them, each built to solve a real problem in how businesses actually run. Job intake, approvals, notifications, scheduling. Configured around your operation, not the other way around."}
          </p>
          <Link href="/contact" className="btn-primary">
            {es ? "Habla con nosotros sobre Suite" : "Talk to us about Suite"}
          </Link>
        </div>
      </section>
      ...
      <section className="py-24" style={{ borderTop: "1px solid #1E1E32", background: "#0D0D1A" }}>
        <div className="max-w-6xl mx-auto px-6">
          <p className="section-label mb-4 text-center">
            {es ? "Qué cubre OLTO Suite" : "What OLTO Suite covers"}
          </p>
      ...
      <section className="py-24" style={{ borderTop: "1px solid #1E1E32" }}>
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="mb-8 max-w-xl mx-auto leading-relaxed" style={{ color: "#9999B0" }}>
            {es
              ? "Las herramientas de OLTO Suite se configuran alrededor de cómo tu negocio realmente funciona. No te entregamos software y un manual — construimos el sistema, lo integramos con tu stack, y te lo entregamos funcionando."
              : "OLTO Suite tools are configured around how your business actually runs. We don't hand you software and a manual — we build the system, integrate it with your stack, and hand it over working."}
          </p>
          <Link href="/contact" className="btn-primary">
