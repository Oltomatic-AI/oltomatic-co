...
export default function Home() {
  ...
  const products = [
    { name: t("nav_voice"), tag: t("voice_tag"), description: t("voice_desc"), href: "/voice",
      features: [t("feat_voice1"), t("feat_voice2"), t("feat_voice3"), t("feat_voice4")],
      number: "01", accent: "#BE3A55",
      iconPath: "M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" },
    { name: "OLTO Suite", tag: t("suite_tag"), description: t("suite_desc_card"), href: "/suite",
      features: [t("feat_suite1"), t("feat_suite2"), t("feat_suite3"), t("feat_suite4")],
      number: "02", accent: "#1560A8",
      iconPath: "M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" },
    { name: "Oltomatic Bespoke", tag: t("bespoke_tag"), description: t("bespoke_card_desc"), href: "/contact",
      features: [t("bespoke_i1"), t("bespoke_i2"), t("bespoke_i3"), t("bespoke_i4")],
