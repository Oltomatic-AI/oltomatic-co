        ...
        <div className="relative max-w-6xl mx-auto px-6 pt-36 pb-28 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="animate-fade-up-4 hidden lg:block">
              <div className="card p-8 blue-glow relative overflow-hidden"
                ...
                <div className="grid grid-cols-2 gap-x-8 gap-y-10">
                  {[
                    ...
                    { value: "£0", label: "revenue from a prospect that was never found" },
                    { value: "40hrs", label: "lost weekly to manual operational tasks" },
                    { value: "3–5×", label: "ROI from AI-first operations" },
                  ].map((s) => (
                    <div key={s.label}>
                      <div className="stat-number blue-text mb-2">{s.value}</div>
                      <p style={{ fontSize: "12px", color: "#55556A", lineHeight: "1.5" }}>{s.label}</p>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <h2 className="font-bold mb-6 leading-tight"
                style={{ fontSize: "clamp(32px, 3.5vw, 48px)", color: "#EEEEF5" }}>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <h2 className="font-bold mb-6 leading-tight"
                style={{ fontSize: "clamp(28px, 3.5vw, 44px)", color: "#EEEEF5" }}>
                ...
                <div key={item.step}>
                  <div className="flex gap-5 py-6">
                    <div className="flex flex-col items-center gap-2">
                      ...
                      {i < arr.length - 1 && <div className="w-px flex-1" style={{ background: "#1E1E32", minHeight: "16px" }} />}
                    </div>
                    <div className="pb-1">
      ...
      <section className="py-28 relative overflow-hidden" style={{ borderTop: "1px solid #1E1E32" }}>
        ...
        <div className="relative max-w-3xl mx-auto px-6 text-center">
          ...
          <h2 className="font-bold mb-5 leading-tight"
            style={{ fontSize: "clamp(32px, 4vw, 56px)", color: "#EEEEF5" }}>
            Ready to run leaner?
          </h2>
          <p className="mb-10 leading-relaxed"
            style={{ color: "#9999B0", fontSize: "18px", maxWidth: "440px", margin: "0 auto 40px" }}>
