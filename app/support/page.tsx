        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="flex flex-col gap-4">
              ...
              {[
                { title: es ? "Preguntas frecuentes" : "Check our FAQ", href: "/voice", label: es ? "FAQs OLTO Voz →" : "Voice FAQs →" },
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div>
                      ...
                      <select name="product" value={form.product} onChange={handleChange} style={inputStyle}>
                        {["General", es ? "OLTO Voz" : "OLTO Voice", "OLTO Suite", es ? "Proyecto a medida" : "Bespoke project"].map(o => <option key={o}>{o}</option>)}
                      </select>
                    </div>
                    <div>
